...
const TEXT_SIZES = ['base', 'lg', 'xl', '2xl', '3xl', '4xl', '5xl', '6xl', '7xl', '8xl', '9xl'];
...
export class BuiAmountOptionTile extends LitElement {
    ...
    renderContent(isSelected, isCustom, hasAmount, isBitcoinFirst) {
...
BuiAmountOptionTile.properties = {
...
//# sourceMappingURL=amount-option-tile.js.map