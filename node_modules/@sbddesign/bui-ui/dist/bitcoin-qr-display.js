...
const OPTIONS = ['unified', 'lightning', 'onchain'];
const SELECTORS = ['dots', 'toggle'];
const DOT_TYPES = ['dot', 'square', 'rounded', 'extra-rounded', 'classy', 'classy-rounded', 'random-dot', 'vertical-line', 'horizontal-line', 'small-square', 'tiny-square', 'diamond'];
const OPTION_LABELS = {
    unified: 'Bitcoin QR',
    onchain: 'On-chain',
    lightning: 'Lightning',
...
export class BuiBitcoinQrDisplay extends LitElement {
    ...
    get effectiveOption() {
        if (this.address && !this.lightning)
            return 'onchain';
        if (this.lightning && !this.address)
            return 'lightning';
        return this.option;
    }
    ...
    async updateQRCode() {
        ...
        this.qrContainer = this.shadowRoot?.querySelector('.qr-container');
        if (!this.qrContainer || this.isUpdatingQR)
            return;
    ...
    cycleOption() {
        if (!this.shouldShowSelector)
            return;
        const order = ['unified', 'lightning', 'onchain'];
    ...
    renderSelector() {
        if (!this.shouldShowSelector)
            return null;
        if (this.selector === 'toggle')
            return this.renderToggleSelector();
        return html `
...
BuiBitcoinQrDisplay.properties = {
    address: { type: String },
...
//# sourceMappingURL=bitcoin-qr-display.js.map