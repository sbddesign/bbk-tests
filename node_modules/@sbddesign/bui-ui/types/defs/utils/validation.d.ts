...
export declare function createValidationRule<T>(property: PropertyKey, validValues: readonly any[], message?: string): ValidationRule;
export declare function validateEnum<T extends Record<string, any>>(component: any, changedProperties: PropertyValues<any>, enumType: T, property: PropertyKey, message?: string): void;
export declare function createEnumValidationRule<T extends Record<string, any>>(enumType: T, property: PropertyKey, message?: string): ValidationRule;
