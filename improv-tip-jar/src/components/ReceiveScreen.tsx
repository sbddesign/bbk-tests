    ...
    const createPayment = async () => {
      ...
      try {
        ...
        const result = await createTipPaymentMethods(
          amount,
          `Bitcoin tip for $${amount} - ${import.meta.env.VITE_TIP_JAR_NAME || "Improv Comedy Group"}`
        );
  ...
  return (
    <div className="bg-[var(--background)] min-h-screen flex flex-col items-center justify-start p-12 gap-12">
      ...
      <div className="flex flex-col items-center gap-2">
        ...
        <h1 className="text-4xl font-normal text-center">{import.meta.env.VITE_TIP_JAR_SLOGAN || "Support our comedy!"}</h1>
      </div>
