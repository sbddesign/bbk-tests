...
![Tip Jar](improv-tip-jar.png)

A tip jar for improv comedy groups built with the Bitcoin Builder Kit and [Voltage API](https://docs.voltageapi.com/).

## How It Works

This web app allows your improv comedy group to accept tips in bitcoin from audience members. It offers some simple, predefined amount options with comedy-themed messages, as well as a custom entry for tippers to define their own amount. From there, it fetches a BOLT11 lightning invoice from the Voltage Payments API for the tipper to pay.

Perfect for:
- Improv comedy shows
- Stand-up comedy nights
- Comedy workshops
- Any performance where you want to accept Bitcoin tips
